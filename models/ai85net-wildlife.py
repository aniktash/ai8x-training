...
###################################################################################################
"""
Rock Paper Scissor classification network for AI85
"""
...
class AI85WILDLIFENet(nn.Module):
    """
    Define CNN model for image classification.
    """
    def __init__(self, num_classes=3, num_channels=3, dimensions=(64, 64),
                 fc_inputs=32, bias=False, **kwargs):
        super().__init__()
        ...
        # padding 1 -> no change in dimensions -> 16x64x64
        ...
        self.conv3 = ai8x.FusedMaxPoolConv2dReLU(32, 60, 3, pool_size=2, pool_stride=2, padding=1,
                                                 bias=bias, **kwargs)
        dim //= 2  # pooling, padding 0 -> 60x16x16

        self.conv4 = ai8x.FusedMaxPoolConv2dReLU(60, 32, 3, pool_size=2, pool_stride=2, padding=1,
                                                 bias=bias, **kwargs)
...
def ai85wildlifenet(pretrained=False, **kwargs):
    """
    Constructs a AI85RPSNet model.
    """
    assert not pretrained
    return AI85WILDLIFENet(**kwargs)


models = [
    {
        'name': 'ai85wildlifenet',
        'min_input': 1,
        'dim': 3,
    },
]