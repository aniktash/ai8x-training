...
def rps_get_datasets(data, load_train=True, load_test=True):
    """
    Load Rock Paper Scissor dataset
    """
    (data_dir, args) = data
    path = data_dir
    dataset_path = os.path.join(path, "rps")
    ...
    training_data_path = os.path.join(data_dir, "rps")
    training_data_path = os.path.join(training_data_path, "train")

    test_data_path = os.path.join(data_dir, "rps")
